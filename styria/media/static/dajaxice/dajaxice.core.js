...
var Dajaxice = {
    ...
    insert_rating: function(callback_function, argv, custom_settings){
        return Dajaxice.call('styria.single_image.insert_rating', 'POST', callback_function, argv, custom_settings);
    },

    load_single: function(callback_function, argv, custom_settings){
        return Dajaxice.call('styria.single_image.load_single', 'POST', callback_function, argv, custom_settings);
    },

    insert_comment: function(callback_function, argv, custom_settings){
        return Dajaxice.call('styria.single_image.insert_comment', 'POST', callback_function, argv, custom_settings);
    }
